...
from BrandException.entity.config_entity import ModelPusherConfig
from BrandException.exception import BrandException
from BrandException.logger import logging
...
class ModelPusher:
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifacts:
        ...
        try:
            ...
            raise BrandException(e, sys) from e
